...
/* WEBPACK VAR INJECTION */(function(jQuery) {const { addScript } = __webpack_require__(1);
const { injection } = __webpack_require__(5);
// @ts-ignore
...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    if (request.config === "sendConfig") {
        ...
        (function ($) {
            var m_badgeNum = 0,
                m_hideNotifications = request.pb_hideNotifications,
                m_hideBadge = request.pb_hideBadge;
